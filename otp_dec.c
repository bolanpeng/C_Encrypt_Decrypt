/***********************************************************************
 * This program will connect to otp_dec_d, and ask it to decrypt the
 * passed-in ciphertext using the key provided.
 * 
...
int main(int argc, char **argv) {
  ...
  // Read in the ciphrtext, return the length of the file
  size_t text_length = sizeOfFile(argv[1]);
  
  // Read in the key, return the length of the file
  size_t key_length = sizeOfFile(argv[2]);
  
  // Compare the length of the two files, if key is shorter than ciphertext, exit with error 1
  ...
  /*********************************************************************
   * Write the data in the ciphertext and key file to the server
   * 1. Write the length of the ciphertext
  ...
  // Receive the decrypted text from the server, and output to stdout
